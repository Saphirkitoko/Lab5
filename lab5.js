...
let euros = 100;
let exchange_rate_AUD = rates.AUD;
let equivalent_in_AUD = euros * exchange_rate_AUD;
console.log("Equivalent in AUD:", equivalent_in_AUD);
...
console.log("Gary Oldman's cat's name (using [] notation):", cats_and_owners[1].cat);
...
cats_and_owners.forEach(owner => {
    if (owner.name === "Gary Oldman") {
        console.log("Gary Oldman's cat's name (using loop):", owner.cat);
    }
});
...
console.log("Literature Nobel laureate:", nobel_prize_winners_2017.prizes.find(prize => prize.category === "literature").laureates[0].firstname + " " +
    nobel_prize_winners_2017.prizes.find(prize => prize.category === "literature").laureates[0].surname);
